  ...
  const featuresLeft = [
    {
      ...
      title: 'Self Serve Bays with Hot Water',
      description: "Maximum height 11'6 Open 24 hours",
    },
    {
      id: 2,
      number: '02',
      icon: '/Images/gif/detail.gif',
      title: '4 Vacuums',
      description: 'Efficient and powerful cleaning solutions.',
    },
  ];
  ...
  const featuresRight = [
    {
      ...
      number: '03',
      icon: '/Images/gif/detail.gif',
      title: '1 Shampoo + Spot Remover Vacuum',
    ...
    },
    {
      ...
      number: '04',
      icon: '/Images/gif/detail.gif',
      title: '4th Bay - Dedicated Semi Truck Bay',
      description: 'Ample space for Boats, RVs, & Buses.',
    },
  ];
