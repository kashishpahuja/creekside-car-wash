...
function Banner() {
  return (
    <div className="relative w-full h-[700px] lg:min-h-screen overflow-hidden font-exo pt-[50px]">
        ...
        <div className="">
         ...
         Creekside Car Wash
          ...
          <div className=" mt-12">
            ...
            <Link
            href={"/contact"}
            className="px-4 py-4  2xl:px-6 bg-white hover:bg-black text-black hover:border-2 hover:border-white hover:text-white text-lg 2xl:text-xl font-semibold rounded-lg"
          >
            Book Now
          </Link>
          </div>
