    ...
    // }}
     >
        {/* <div
          ...
          aria-hidden="true"
        ></div> */}
    <div className="relative z-20  text-center py-24 px-6 md:px-12 xl:px-32"
    >
    
   
      <h3 className="montserrat text-2xl  lg:text-3xl font-bold text-black text-center">
      Benefits of Oil Undercoating
      </h3>
      <h3 className=" text-sm mx-6 xl:mx-20 lg:text-lg font-bold text-gray-700 text-center my-8 ">
      ...
      <div className="flex items-start justify-center flex-wrap xl:flex-nowrap gap-12 md:gap-8 lg:gap-0">
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-center p-6 bg-[#97c6da73]">
        ...
        <div className="text-center p-6 bg-[#97c6dae1]">
          <h3 className="montserrat text-2xl font-semibold text-black">
