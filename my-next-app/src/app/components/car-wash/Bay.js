...
export default function CarWashInfo() {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center gap-12 p-6  my-24 bg-[#1f1e1f] px-8 lg:px-20 xl:px-32 py-24">
      ...
      <div className="w-full lg:w-1/2 flex flex-col md:flex-row gap-4">
        <div className="flex flex-col gap-4">
          {featuresTop.map((feature, index) => (
            <div key={index} className="p-6 shadow-md rounded-2xl bg-[#eeebe8] opacity-90 transition-transform transform hover:scale-105">
              ...
              <h3 className="text-xl text-black mt-4">{feature.title}</h3>
              <p className="text-gray-900 mt-2">{feature.description}</p>
            </div>
          ))}
        </div>
