...
function Banner() {
  return (
    <div className="relative w-full h-[600px] lg:min-h-screen overflow-hidden font-exo ">
      ...
      {/* Content */}
      <div className="relative text-white h-full flex items-center justify-start ml-28  overflow-hidden">
        {/* Swiper Section */}
        <div className=" w-[100%] lg:w-[50%] xl:w-[50%] bg-transparent  p-6 z-10">
        <div className="">
          <div>
